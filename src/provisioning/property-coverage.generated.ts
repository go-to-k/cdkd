...
>([
  ...
  [
    'AWS::DynamoDB::Table',
    {
      ...
      silentDrop: new Map<string, string>([
        ['ImportSourceSpecification', "S3 import uses the separate ImportTable API (not CreateTable) and is create-only with no readback; deferred to a dedicated import-from-S3 PR"],
      ]),
    },
  ],
  [
    'AWS::EC2::EIP',
    {
      ...
      silentDrop: new Map<string, string>([
        ...
        ['InstanceId', "The SDK create path does not associate the EIP to an instance (ec2:AssociateAddress); an EIP that sets InstanceId auto-routes to Cloud Control (which does associate it), while the common no-InstanceId EIP takes the fast SDK path"],
  ...
  [
    'AWS::EC2::SecurityGroupIngress',
    {
      ...
      silentDrop: new Map<string, string>([
        ['GroupName', "EC2-Classic-only — use GroupId for VPC security groups (EC2-Classic retired 2022-08-15)"],
        ['SourceSecurityGroupName', "EC2-Classic-only — use SourceSecurityGroupId for VPC peer security groups (EC2-Classic retired 2022-08-15)"],
      ]),
    },
  ],
  [
  ...
  [
    'AWS::EC2::VPCGatewayAttachment',
    {
      ...
      silentDrop: new Map<string, string>([
        ['VpnGatewayId', "not yet implemented by cdkd"],
      ]),
    },
  ],
  [
  ...
  [
    'AWS::ECS::TaskDefinition',
    {
      ...
      silentDrop: new Map<string, string>([
        ['InferenceAccelerators', "AWS Elastic Inference end-of-life 2024-04; use AWS Inferentia / Trainium accelerator instance families instead"],
      ]),
    },
  ],
  [
    'AWS::EFS::AccessPoint',
    {
      ...
      silentDrop: new Map<string, string>([
        ['ClientToken', "AWS SDK manages this idempotency token internally on CreateAccessPoint; no user-supplied value is honored"],
      ]),
    },
  ],
  [
  ...
  [
    'AWS::ElastiCache::CacheCluster',
    {
      ...
      silentDrop: new Map<string, string>([
        ['CacheSecurityGroupNames', "EC2-Classic-only — use VpcSecurityGroupIds for VPC-deployed clusters (EC2-Classic retired 2022-08-15)"],
