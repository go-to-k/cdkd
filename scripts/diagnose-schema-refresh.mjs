      ...
      ? [
          ...
          ...(unresolved.length > 0
            ? [
                ...
                '   a new comment. So the newest comment holds the newest reading — if',
                '   that is the one you are reading, it is current; if there is no',
                '   comment, the body is all there is. Either way, settle it where you',
                '   are rather than waiting, before allow-listing anything:',
                '',
                '   ```bash',
