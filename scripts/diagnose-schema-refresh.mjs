      ...
      ? [
          ...
          ...(unresolved.length > 0
            ? [
                ...
                '',
                '   **Do not wait for this section to answer it.** The reading is',
                '   recomputed every cycle, but this text was written once, on the day',
                '   the pull request opened, and no later cycle rewrites it: one that',
                '   publishes a change posts its fresh reading as a new COMMENT',
                '   instead. So read the newest comment for a current answer — and if',
                '   there is none, settle it where you are, before allow-listing',
                '   anything:',
                '',
                '   ```bash',
