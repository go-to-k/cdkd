 ...
 *     here would paper over a real defect in the PR body. (A merge-time hook
 *     used to refuse it too; that gate is retired to CI by go-to-k/cdkd#2717,
 *     so this workflow's silence is now the only signal)
