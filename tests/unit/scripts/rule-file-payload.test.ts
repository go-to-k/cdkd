...
const PAYLOAD_BUDGETS: ReadonlyArray<readonly [string, number, number]> = [
  ...
  // hooks-main-tree-edit.md.
  ['.claude/hooks/main-tree-edit-gate.sh', 40_000, 95_000], // measured 81,762
...
const CORPUS_FILE_COUNT = 46; // + hooks-main-tree-edit.md (go-to-k/cdkd#2614):
                              //  main-tree-edit-gate's entry moved out of hooks.md verbatim,
                              //  with its main-tree-dirty-detector backstop, when the
                              //  shared-`cd`-resolver note took hooks.md to 80,352 B against the
                              //  80,000 B cap. hooks.md 79,891 -> 78,437 B.
