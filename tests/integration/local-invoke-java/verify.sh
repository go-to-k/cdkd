...
RESULT_1=$(capture ${CDKD} local invoke CdkdLocalInvokeJavaFixture/EchoHandler --no-pull)
...
RESULT_2=$(capture ${CDKD} local invoke CdkdLocalInvokeJavaFixture/EchoHandler --event "${EVENT_FILE}" --no-pull)
