...
# arms (up to ~18 min since issue #1950 raised `DELETE_INDEX_BUSY_MAX_RETRIES`
# to 14), and the delete loop under it is bounded at ~19 min, so a second pass
# costs ~40 min of teardown after the user has already asked the run to stop.
CLEANED_UP=0
