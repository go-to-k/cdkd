...
RESULT_1=$(capture ${CDKD} local invoke CdkdLocalInvokeRubyFixture/EchoHandler --no-pull)
...
RESULT_2=$(capture ${CDKD} local invoke CdkdLocalInvokeRubyFixture/EchoHandler --event "${EVENT_FILE}" --no-pull)
...
RESULT_3=$(capture ${CDKD} local invoke CdkdLocalInvokeRubyFixture/EchoHandler --env-vars "${ENV_FILE}" --no-pull)
...
RESULT_4=$(capture ${CDKD} local invoke CdkdLocalInvokeRubyFixture/InlineHandler --event "${INLINE_EVENT}" --no-pull)
