...
## [0.291.33](https://github.com/go-to-k/cdkd/compare/v0.291.32...v0.291.33) (2026-09-26)


### Bug Fixes

* **intrinsics:** refuse a list where Fn::Sub needs a string, as CloudFormation does ([#3821](https://github.com/go-to-k/cdkd/issues/3821)) ([de02abc](https://github.com/go-to-k/cdkd/commit/de02abc1c30cb436344b7492757d77d28948e937))

## [0.291.32](https://github.com/go-to-k/cdkd/compare/v0.291.31...v0.291.32) (2026-09-26)


### Bug Fixes

* **deployment:** credit "already exists" prose only when AWS said it and the provider relayed it ([#3822](https://github.com/go-to-k/cdkd/issues/3822)) ([39fbe48](https://github.com/go-to-k/cdkd/commit/39fbe48cd9b74654dcb5e9e40683e8959c24318d))
* **deployment:** let Route 53 declare its CNAME conflict with a structural marker, restoring main ([#3825](https://github.com/go-to-k/cdkd/issues/3825)) ([9feb3af](https://github.com/go-to-k/cdkd/commit/9feb3af3d92ed7a050c87ae74732fbcb79962236))
* **diff:** give a promoted reader's create-only property the CFn-schema fallback on types outside the replacement registry ([#3818](https://github.com/go-to-k/cdkd/issues/3818)) ([50e8f19](https://github.com/go-to-k/cdkd/commit/50e8f190b3863437ea5f913df627212eb2f9491b))
* **diff:** match the deploy on symlinked nested-template cycles, replaced-row routing and nested Type changes ([#3813](https://github.com/go-to-k/cdkd/issues/3813)) ([a9fc200](https://github.com/go-to-k/cdkd/commit/a9fc2002c8428ec4afd0fa9aeaf319c62ad1f063))
* **nested-stack:** revert a nested child from its own rollback journal, not a template re-deploy ([#3829](https://github.com/go-to-k/cdkd/issues/3829)) ([475117c](https://github.com/go-to-k/cdkd/commit/475117c3d094c10319c8d77ca35df12e4df80cd9))
* **providers:** delete the old Route 53 record when a RecordSet is renamed ([#3812](https://github.com/go-to-k/cdkd/issues/3812)) ([97d3d02](https://github.com/go-to-k/cdkd/commit/97d3d02b657c8066badaed4ff6c4c2967cfbbb11))
