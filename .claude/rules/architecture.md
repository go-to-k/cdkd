...
4. **Intrinsic Function Resolution**
   ...
   - **A deliberate REFUSAL propagates out of `Fn::Sub` (issue [#1740](https://github.com/go-to-k/cdkd/issues/1740)).** Which refusals, which of them `markNonRetryable`, and which consumer branches on the `CrossAccountSecretRefusalError` subclass: [intrinsic-refusals.md](intrinsic-refusals.md).
