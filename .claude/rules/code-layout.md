...
| `src/deployment/secret-redaction.ts` and siblings, `src/cli/commands/scrub.ts` | [layout-deployment-secrets.md](layout-deployment-secrets.md) | dynamic-reference secret redaction, masking retry loggers, `cdkd scrub` |
