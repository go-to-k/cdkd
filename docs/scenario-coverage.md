...
**36 / 36 canonical scenarios** have at least one integ fixture exercising them. **104 / 111 integ fixtures** carry a `.scenarios.json` sidecar (with 0+ tags); the rest are un-annotated and contributor-reviewed below.
