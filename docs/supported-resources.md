...
| **CloudFormation** | AWS::CloudFormation::Stack (nested stacks, fresh deploy only — adoption deferred to [#464](https://github.com/go-to-k/cdkd/issues/464)) | SDK Provider | ✅ |
