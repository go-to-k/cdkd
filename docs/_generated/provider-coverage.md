...
- Generated: `2026-06-21T16:53:22.680Z`
- Schema version: 1
- Total CFn resource types audited: **1606**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 115 |
| **Tier 2** | Cloud Control API fallback | 1316 |
| **Tier 3** | Not provisionable by cdkd today | 175 |
