...
- Generated: `2026-07-18T01:57:04.040Z`
- Schema version: 1
- Total CFn resource types audited: **1643**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 127 |
| **Tier 2** | Cloud Control API fallback | 1352 |
| **Tier 3** | Not provisionable by cdkd today | 164 |
