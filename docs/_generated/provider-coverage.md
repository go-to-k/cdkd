...
- Generated: `2026-05-26T08:16:30.610Z`
- Schema version: 1
- Total CFn resource types audited: **1588**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 113 |
| **Tier 2** | Cloud Control API fallback | 1297 |
| **Tier 3** | Not provisionable by cdkd today | 178 |
