...
- Generated: `2026-07-30T16:20:11.451Z`
- Schema version: 1
- Total CFn resource types audited: **1704**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 133 |
| **Tier 2** | Cloud Control API fallback | 1370 |
| **Tier 3** | Not provisionable by cdkd today | 201 |
