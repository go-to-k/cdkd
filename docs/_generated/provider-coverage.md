...
- Generated: `2026-05-16T01:16:13.240Z`
- Schema version: 1
- Total CFn resource types audited: **1584**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 111 |
| **Tier 2** | Cloud Control API fallback | 1293 |
| **Tier 3** | Not provisionable by cdkd today | 180 |
