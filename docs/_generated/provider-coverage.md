...
- Generated: `2026-07-23T12:37:24.767Z`
- Schema version: 1
- Total CFn resource types audited: **1687**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 131 |
| **Tier 2** | Cloud Control API fallback | 1361 |
| **Tier 3** | Not provisionable by cdkd today | 195 |
