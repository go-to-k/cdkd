...
- Generated: `2026-07-02T13:13:17.603Z`
- Schema version: 1
- Total CFn resource types audited: **1623**

## Summary

| Tier | Provisioning path | Count |
|------|-------------------|-------|
| **Tier 1** | SDK Provider (preferred) | 116 |
| **Tier 2** | Cloud Control API fallback | 1335 |
| **Tier 3** | Not provisionable by cdkd today | 172 |
