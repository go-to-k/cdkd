...
- [x] SDK Provider 対応リソース (12種: IAM Role, IAM Policy, S3 BucketPolicy, SQS QueuePolicy, EventBridge Rule, EventBridge EventBus, API Gateway Account/Resource/Deployment/Stage/Method, CloudFront OAI, AgentCore Runtime)
- [x] カスタムリソース対応状況
- [x] 未対応機能一覧
...
3. **Custom Resource Step Functions 直接統合** (優先度: 低)
