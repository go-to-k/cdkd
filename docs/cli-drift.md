...
update-not-supported ones. (`[stacks...]` is the spelling `cdkd drift --help`
and the partial-failure message both use; `cdkd deploy` declares its own
positional differently.)
